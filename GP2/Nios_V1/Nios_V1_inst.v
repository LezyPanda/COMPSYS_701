	Nios_V1 u0 (
		...
		.tdma_recv_addr_external_connection_export (<connected-to-tdma_recv_addr_external_connection_export>), // tdma_recv_addr_external_connection.export
		.tdma_recv_data_external_connection_export (<connected-to-tdma_recv_data_external_connection_export>), // tdma_recv_data_external_connection.export
		.tdma_send_addr_external_connection_export (<connected-to-tdma_send_addr_external_connection_export>), // tdma_send_addr_external_connection.export
		.tdma_send_data_external_connection_export (<connected-to-tdma_send_data_external_connection_export>)  // tdma_send_data_external_connection.export
	);
